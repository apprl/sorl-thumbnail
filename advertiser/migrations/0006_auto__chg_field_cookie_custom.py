...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'advertiser_cookie', 'custom', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Cookie.custom'
        db.alter_column(u'advertiser_cookie', 'custom', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
