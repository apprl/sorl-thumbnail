...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreInvoice'
        db.create_table(u'advertiser_storeinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', to=orm['advertiser.Store'])),
        ...
        db.send_create_signal(u'advertiser', ['StoreInvoice'])

        # Adding field 'Transaction.invoice'
        db.add_column(u'advertiser_transaction', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='transactions', null=True, on_delete=models.SET_NULL, to=orm['advertiser.StoreInvoice']),
                      keep_default=False)

        # Adding field 'Transaction.is_paid'
        db.add_column(u'advertiser_transaction', 'is_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StoreInvoice'
        db.delete_table(u'advertiser_storeinvoice')

        # Deleting field 'Transaction.invoice'
        db.delete_column(u'advertiser_transaction', 'invoice_id')

        # Deleting field 'Transaction.is_paid'
        db.delete_column(u'advertiser_transaction', 'is_paid')
