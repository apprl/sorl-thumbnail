...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.custom'
        db.alter_column(u'advertiser_transaction', 'custom', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.custom'
        db.alter_column(u'advertiser_transaction', 'custom', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
