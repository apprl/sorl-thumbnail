...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.automatic_accept'
        db.add_column(u'advertiser_transaction', 'automatic_accept',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.automatic_accept'
        db.delete_column(u'advertiser_transaction', 'automatic_accept')
