...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvitePerUser.user'
        db.alter_column('beta_inviteperuser', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['profile.ApparelProfile']))
    
    
    def backwards(self, orm):
        
        # Changing field 'InvitePerUser.user'
        db.alter_column('beta_inviteperuser', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
