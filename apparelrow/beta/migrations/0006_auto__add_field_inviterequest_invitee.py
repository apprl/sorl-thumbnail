...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InviteRequest.invitee'
        db.add_column('beta_inviterequest', 'invitee', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['beta.Invitee'], unique=True, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InviteRequest.invitee'
        db.delete_column('beta_inviterequest', 'invitee_id')
    ...
    models = {
        ...
        'beta.invitee': {
            ...
            'used_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'beta.inviteperuser': {
            'Meta': {'object_name': 'InvitePerUser'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invites': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'beta'", 'unique': 'True', 'to': "orm['profile.ApparelProfile']"})
        },
        'beta.inviterequest': {
            'Meta': {'object_name': 'InviteRequest'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitee': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['beta.Invitee']", 'unique': 'True', 'null': 'True'})
        },
