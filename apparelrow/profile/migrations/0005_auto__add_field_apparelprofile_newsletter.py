...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.newsletter'
        db.add_column('profile_apparelprofile', 'newsletter', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.newsletter'
        db.delete_column('profile_apparelprofile', 'newsletter')
