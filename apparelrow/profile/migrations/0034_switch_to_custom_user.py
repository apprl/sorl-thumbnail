...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('auth_user', 'profile_user')
        db.rename_table('auth_user_groups', 'profile_user_groups')
        db.rename_table('auth_user_user_permissions', 'profile_user_user_permissions')

    def backwards(self, orm):
        db.rename_table('profile_user', 'auth_user')
        db.rename_table('profile_user_groups', 'auth_user_groups')
        db.rename_table('profile_user_user_permissions', 'auth_user_user_permissions')
