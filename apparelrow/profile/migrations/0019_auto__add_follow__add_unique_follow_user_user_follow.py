...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table('profile_follow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='following', to=orm['profile.ApparelProfile'])),
            ('user_follow', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followers', to=orm['profile.ApparelProfile'])),
        ...
        db.send_create_signal('profile', ['Follow'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profile_follow')
