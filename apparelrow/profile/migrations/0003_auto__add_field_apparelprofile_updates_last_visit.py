...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.updates_last_visit'
        db.add_column('profile_apparelprofile', 'updates_last_visit', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.updates_last_visit'
        db.delete_column('profile_apparelprofile', 'updates_last_visit')
