...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentDetail.care_of'
        db.add_column(u'profile_paymentdetail', 'care_of',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PaymentDetail.banknr'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PaymentDetail.care_of'
        db.delete_column(u'profile_paymentdetail', 'care_of')


        # Changing field 'PaymentDetail.banknr'
        db.alter_column(u'profile_paymentdetail', 'banknr', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
