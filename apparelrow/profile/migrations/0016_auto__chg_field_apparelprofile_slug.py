...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApparelProfile.slug'
        db.alter_column('profile_apparelprofile', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))


    def backwards(self, orm):
        # Changing field 'ApparelProfile.slug'
        db.alter_column('profile_apparelprofile', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, unique=True, max_length=100, separator=u'-', null=True, populate_from=('name',), overwrite=False))
