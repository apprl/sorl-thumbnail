...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.is_brand'
        db.add_column('profile_apparelprofile', 'is_brand', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.is_brand'
        db.delete_column('profile_apparelprofile', 'is_brand')
