...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.manual_about'
        db.add_column('profile_user', 'manual_about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.manual_about_en'
        db.add_column('profile_user', 'manual_about_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.manual_about_sv'
        db.add_column('profile_user', 'manual_about_sv',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.manual_about_da'
        db.add_column('profile_user', 'manual_about_da',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.manual_about_no'
        db.add_column('profile_user', 'manual_about_no',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.manual_about'
        db.delete_column('profile_user', 'manual_about')

        # Deleting field 'User.manual_about_en'
        db.delete_column('profile_user', 'manual_about_en')

        # Deleting field 'User.manual_about_sv'
        db.delete_column('profile_user', 'manual_about_sv')

        # Deleting field 'User.manual_about_da'
        db.delete_column('profile_user', 'manual_about_da')

        # Deleting field 'User.manual_about_no'
        db.delete_column('profile_user', 'manual_about_no')
