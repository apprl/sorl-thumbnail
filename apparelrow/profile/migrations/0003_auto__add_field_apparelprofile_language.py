...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.language'
        db.add_column('profile_apparelprofile', 'language', self.gf('django.db.models.fields.CharField')(default='sv', max_length=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.language'
        db.delete_column('profile_apparelprofile', 'language')
