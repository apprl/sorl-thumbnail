...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.brand'
        db.add_column('profile_apparelprofile', 'brand', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='profile', unique=True, null=True, to=orm['apparel.Brand']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.brand'
        db.delete_column('profile_apparelprofile', 'brand_id')
