...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentDetail.address'
        db.add_column('profile_paymentdetail', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PaymentDetail.postal_code'
        db.add_column('profile_paymentdetail', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PaymentDetail.city'
        db.add_column('profile_paymentdetail', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentDetail.address'
        db.delete_column('profile_paymentdetail', 'address')

        # Deleting field 'PaymentDetail.postal_code'
        db.delete_column('profile_paymentdetail', 'postal_code')

        # Deleting field 'PaymentDetail.city'
        db.delete_column('profile_paymentdetail', 'city')
    ...
    models = {
        ...
        'profile.apparelprofile': {
            ...
            'partner_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dashboard.Group']", 'null': 'True', 'blank': 'True'}),
