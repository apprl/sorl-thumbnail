...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.referral_partner'
        db.add_column('profile_user', 'referral_partner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.referral_partner_code'
        db.add_column('profile_user', 'referral_partner_code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.referral_partner_parent'
        db.add_column('profile_user', 'referral_partner_parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.referral_partner_parent_date'
        db.add_column('profile_user', 'referral_partner_parent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.referral_partner'
        db.delete_column('profile_user', 'referral_partner')

        # Deleting field 'User.referral_partner_code'
        db.delete_column('profile_user', 'referral_partner_code')

        # Deleting field 'User.referral_partner_parent'
        db.delete_column('profile_user', 'referral_partner_parent_id')

        # Deleting field 'User.referral_partner_parent_date'
        db.delete_column('profile_user', 'referral_partner_parent_date')
