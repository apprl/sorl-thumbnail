...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.facebook_friends'
        db.add_column('profile_apparelprofile', 'facebook_friends',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.facebook_friends'
        db.delete_column('profile_apparelprofile', 'facebook_friends')
