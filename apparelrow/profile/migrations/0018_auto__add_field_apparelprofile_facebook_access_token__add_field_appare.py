...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.facebook_access_token'
        db.add_column('profile_apparelprofile', 'facebook_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApparelProfile.facebook_access_token_expire'
        db.add_column('profile_apparelprofile', 'facebook_access_token_expire',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.facebook_access_token'
        db.delete_column('profile_apparelprofile', 'facebook_access_token')

        # Deleting field 'ApparelProfile.facebook_access_token_expire'
        db.delete_column('profile_apparelprofile', 'facebook_access_token_expire')
