...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentDetail.notes'
        db.add_column(u'profile_paymentdetail', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentDetail.notes'
        db.delete_column(u'profile_paymentdetail', 'notes')
