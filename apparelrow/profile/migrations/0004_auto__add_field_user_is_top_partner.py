...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_top_partner'
        db.add_column('profile_user', 'is_top_partner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.is_top_partner'
        db.delete_column('profile_user', 'is_top_partner')
