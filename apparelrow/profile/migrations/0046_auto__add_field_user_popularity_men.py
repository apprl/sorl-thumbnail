...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.popularity_men'
        db.add_column('profile_user', 'popularity_men',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.popularity_men'
        db.delete_column('profile_user', 'popularity_men')
