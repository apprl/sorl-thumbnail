...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['profile.ApparelProfile'].objects.filter(login_flow='initial').update(login_flow='bio')

    def backwards(self, orm):
        orm['profile.ApparelProfile'].objects.filter(login_flow='bio').update(login_flow='initial')
