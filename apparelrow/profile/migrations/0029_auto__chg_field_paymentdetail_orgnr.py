...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentDetail.orgnr'
        db.alter_column('profile_paymentdetail', 'orgnr', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PaymentDetail.orgnr'
        raise RuntimeError("Cannot reverse this migration. 'PaymentDetail.orgnr' and its values cannot be restored.")
