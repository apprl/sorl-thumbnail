...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.first_visit'
        db.add_column('profile_apparelprofile', 'first_visit', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.first_visit'
        db.delete_column('profile_apparelprofile', 'first_visit')
