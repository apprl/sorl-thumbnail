...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'profile_user', 'location')


    def backwards(self, orm):
        # Adding model 'NotificationEvent'
        db.create_table(u'profile_notificationevent', (
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', null=True, to=orm['apparel.Product'], blank=True)),
            ...
            ('look', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', null=True, to=orm['apparel.Look'], blank=True)),
            ('sale_new_price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='performed_events', null=True, to=orm['profile.User'], blank=True)),
        ...
        db.add_column(u'profile_user', 'location',
