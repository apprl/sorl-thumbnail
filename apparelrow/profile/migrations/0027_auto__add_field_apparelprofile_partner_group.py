...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.partner_group'
        db.add_column('profile_apparelprofile', 'partner_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.partner_group'
        db.delete_column('profile_apparelprofile', 'partner_group_id')
    ...
    models = {
        ...
        'dashboard.cut': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cuts'", 'on_delete': 'models.PROTECT', 'to': "orm['apparel.Vendor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'vendor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apparel.Vendor']"})
        },
        'dashboard.group': {
    ...
    complete_apps = ['dashboard', 'profile']