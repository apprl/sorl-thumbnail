...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.blog_url'
        db.add_column('profile_apparelprofile', 'blog_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.blog_url'
        db.delete_column('profile_apparelprofile', 'blog_url')
