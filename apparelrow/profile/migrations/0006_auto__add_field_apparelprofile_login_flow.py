...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.login_flow'
        db.add_column('profile_apparelprofile', 'login_flow', self.gf('django.db.models.fields.CharField')(default='initial', max_length=20), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.login_flow'
        db.delete_column('profile_apparelprofile', 'login_flow')
