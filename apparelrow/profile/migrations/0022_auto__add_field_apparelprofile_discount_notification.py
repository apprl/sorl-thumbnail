...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.discount_notification'
        db.add_column('profile_apparelprofile', 'discount_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.discount_notification'
        db.delete_column('profile_apparelprofile', 'discount_notification')
