...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Follow.user_follow'
        db.alter_column(u'profile_follow', 'user_follow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User']))

        # Changing field 'Follow.user'
        db.alter_column(u'profile_follow', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User']))

    def backwards(self, orm):

        # Changing field 'Follow.user_follow'
        db.alter_column(u'profile_follow', 'user_follow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.ApparelProfile']))

        # Changing field 'Follow.user'
        db.alter_column(u'profile_follow', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.ApparelProfile']))
