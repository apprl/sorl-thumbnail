...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.owner_network'
        db.add_column('profile_user', 'owner_network',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='publisher_network', null=True, to=orm['profile.User']),
                      keep_default=False)

        # Adding field 'User.is_subscriber'
        db.add_column('profile_user', 'is_subscriber',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profile_user', 'owner_network_id')
