...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ApparelProfile', fields ['name']
        db.delete_unique('profile_apparelprofile', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'ApparelProfile', fields ['name']
        db.create_unique('profile_apparelprofile', ['name'])
