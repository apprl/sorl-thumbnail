...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.fb_share_like_product'
        db.add_column('profile_apparelprofile', 'fb_share_like_product',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApparelProfile.fb_share_like_look'
        db.add_column('profile_apparelprofile', 'fb_share_like_look',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApparelProfile.fb_share_follow_profile'
        db.add_column('profile_apparelprofile', 'fb_share_follow_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApparelProfile.fb_share_create_look'
        db.add_column('profile_apparelprofile', 'fb_share_create_look',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.fb_share_like_product'
        db.delete_column('profile_apparelprofile', 'fb_share_like_product')

        # Deleting field 'ApparelProfile.fb_share_like_look'
        db.delete_column('profile_apparelprofile', 'fb_share_like_look')

        # Deleting field 'ApparelProfile.fb_share_follow_profile'
        db.delete_column('profile_apparelprofile', 'fb_share_follow_profile')

        # Deleting field 'ApparelProfile.fb_share_create_look'
        db.delete_column('profile_apparelprofile', 'fb_share_create_look')
