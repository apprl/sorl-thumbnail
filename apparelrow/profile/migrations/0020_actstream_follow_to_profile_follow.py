...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for follow in orm['actstream.Follow'].objects.all():
            profile = orm['profile.ApparelProfile'].objects.get(user_id=follow.user_id)
            profile_follow = orm['profile.ApparelProfile'].objects.get(user_id=follow.object_id)
            orm['profile.Follow'].objects.create(user=profile, user_follow=profile_follow)

    def backwards(self, orm):
        orm['profile.Follow'].objects.all().delete()
    ...
    complete_apps = ['actstream', 'profile']
    symmetrical = True
