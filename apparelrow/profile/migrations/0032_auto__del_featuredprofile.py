...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('profile_featuredprofile')


    def backwards(self, orm):
        # Adding model 'FeaturedProfile'
        db.create_table('profile_featuredprofile', (
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.ApparelProfile'])),
        ...
        db.send_create_signal('profile', ['FeaturedProfile'])
