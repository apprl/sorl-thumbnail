...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.popularity'
        db.add_column('profile_apparelprofile', 'popularity',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApparelProfile.popularity'
        db.delete_column('profile_apparelprofile', 'popularity')
