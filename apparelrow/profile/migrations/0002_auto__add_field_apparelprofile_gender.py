...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.gender'
        db.add_column('profile_apparelprofile', 'gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=1, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.gender'
        db.delete_column('profile_apparelprofile', 'gender')
