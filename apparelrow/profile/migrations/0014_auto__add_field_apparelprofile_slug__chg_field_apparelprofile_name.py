...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApparelProfile.slug'
        db.add_column('profile_apparelprofile', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(null=True, populate_from=('name',), allow_duplicates=False, max_length=100, separator=u'-', blank=True, unique=True, overwrite=False),
                      keep_default=False)


        # Changing field 'ApparelProfile.name'
        db.alter_column('profile_apparelprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'ApparelProfile.slug'
        db.delete_column('profile_apparelprofile', 'slug')


        # Changing field 'ApparelProfile.name'
        db.alter_column('profile_apparelprofile', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True))
