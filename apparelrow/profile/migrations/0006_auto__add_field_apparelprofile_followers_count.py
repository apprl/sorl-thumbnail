...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApparelProfile.followers_count'
        db.add_column('profile_apparelprofile', 'followers_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ApparelProfile.followers_count'
        db.delete_column('profile_apparelprofile', 'followers_count')
