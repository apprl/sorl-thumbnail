...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.confirmation_key'
        db.add_column('profile_user', 'confirmation_key',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.confirmation_key'
        db.delete_column('profile_user', 'confirmation_key')
