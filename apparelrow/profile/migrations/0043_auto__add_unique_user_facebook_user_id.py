...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'User', fields ['facebook_user_id']
        db.create_unique('profile_user', ['facebook_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'User', fields ['facebook_user_id']
        db.delete_unique('profile_user', ['facebook_user_id'])
