...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductStat.product'
        db.alter_column(u'statistics_productstat', 'product', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ProductStat.price'
        db.alter_column(u'statistics_productstat', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProductStat.vendor'
        db.alter_column(u'statistics_productstat', 'vendor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ProductStat.product'
        db.alter_column(u'statistics_productstat', 'product', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'ProductStat.price'
        db.alter_column(u'statistics_productstat', 'price', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ProductStat.vendor'
        db.alter_column(u'statistics_productstat', 'vendor', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
