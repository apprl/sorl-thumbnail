...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductStat.source_link'
        db.add_column(u'statistics_productstat', 'source_link',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductStat.source_link'
        db.delete_column(u'statistics_productstat', 'source_link')
