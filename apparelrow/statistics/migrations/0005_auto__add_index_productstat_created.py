...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ProductStat', fields ['created']
        db.create_index(u'statistics_productstat', ['created'])


    def backwards(self, orm):
        # Removing index on 'ProductStat', fields ['created']
        db.delete_index(u'statistics_productstat', ['created'])
