...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('statistics_notificationemailstats', (
        ...
        db.send_create_signal('statistics', ['NotificationEmailStats'])


    def backwards(self, orm):
        # Deleting model 'NotificationEmailStats'
        db.delete_table('statistics_notificationemailstats')
    ...
    models = {
        ...
        'statistics.notificationemailstats': {
        ...
        'statistics.productstats': {
            'Meta': {'ordering': "['-created']", 'object_name': 'ProductStats'},
