...
urlpatterns = patterns('',
    ...
    url(r'^accounts/register/email/$', 'profile.views.register_email', name='auth_register_email'),
    url(r'^accounts/register/complete/$', 'profile.views.register_complete', name='auth_register_complete'),
    url(r'^accounts/activate/(?P<key>[\w-]+)/$', 'profile.views.register_activate', name='auth_register_activate'),
    ...
    url(r'^facebook/login', 'profile.views.facebook_login', name='facebook_login'),
