...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VendorFeed.comment'
        db.add_column('importer_vendorfeed', 'comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VendorFeed.comment'
        db.delete_column('importer_vendorfeed', 'comment')
