...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for vc in orm['apparel.VendorCategory'].objects.all():
            vc.created = timezone.datetime(2013, 11, 17, 9, 10, 0)
            vc.save()

        for vb in orm['apparel.VendorBrand'].objects.all():
            vb.created = timezone.datetime(2013, 11, 17, 9, 10, 0)
            vb.save()
