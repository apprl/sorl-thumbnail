...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VendorProduct.discount_price'
        db.add_column('apparel_vendorproduct', 'discount_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'VendorProduct.original_discount_price'
        db.add_column('apparel_vendorproduct', 'original_discount_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'VendorProduct.discount_currency'
        db.add_column('apparel_vendorproduct', 'discount_currency', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'VendorProduct.original_discount_currency'
        db.add_column('apparel_vendorproduct', 'original_discount_currency', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VendorProduct.discount_price'
        db.delete_column('apparel_vendorproduct', 'discount_price')

        # Deleting field 'VendorProduct.original_discount_price'
        db.delete_column('apparel_vendorproduct', 'original_discount_price')

        # Deleting field 'VendorProduct.discount_currency'
        db.delete_column('apparel_vendorproduct', 'discount_currency')

        # Deleting field 'VendorProduct.original_discount_currency'
        db.delete_column('apparel_vendorproduct', 'original_discount_currency')
    ...
    models = {
        ...
        'apparel.product': {
            ...
            'popularity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8'}),
