...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('apparel_brand', 'slug')


    def backwards(self, orm):
        # Adding field 'Brand.slug'
        db.add_column('apparel_brand', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, unique=True, max_length=100, separator=u'-', blank=True, null=True, populate_from=('name',), overwrite=False),
                      keep_default=False)
