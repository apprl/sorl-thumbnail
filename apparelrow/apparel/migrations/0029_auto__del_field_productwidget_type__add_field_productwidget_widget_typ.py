...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductWidget.widget_type'
        db.add_column(u'apparel_productwidget', 'widget_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductWidget.widget_type'
        db.delete_column(u'apparel_productwidget', 'widget_type')
