...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'apparel_category', 'name_da',
                      self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True, default=''),
                      keep_default=False)

        # Adding field 'Category.name_no'
        db.add_column(u'apparel_category', 'name_no',
                      self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True, default=''),
                      keep_default=False)

        # Adding field 'Category.name_order_da'
        db.add_column(u'apparel_category', 'name_order_da',
                      self.gf('django.db.models.fields.CharField')(max_length=100, default=''),
                      keep_default=False)

        # Adding field 'Category.name_order_no'
        db.add_column(u'apparel_category', 'name_order_no',
                      self.gf('django.db.models.fields.CharField')(max_length=100, default=''),
                      keep_default=False)

        # Adding field 'Category.singular_name_da'
        db.add_column(u'apparel_category', 'singular_name_da',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Category.singular_name_no'
        db.add_column(u'apparel_category', 'singular_name_no',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'apparel_category', 'name_da')

        # Deleting field 'Category.name_no'
        db.delete_column(u'apparel_category', 'name_no')

        # Deleting field 'Category.name_order_da'
        db.delete_column(u'apparel_category', 'name_order_da')

        # Deleting field 'Category.name_order_no'
        db.delete_column(u'apparel_category', 'name_order_no')

        # Deleting field 'Category.singular_name_da'
        db.delete_column(u'apparel_category', 'singular_name_da')

        # Deleting field 'Category.singular_name_no'
        db.delete_column(u'apparel_category', 'singular_name_no')
