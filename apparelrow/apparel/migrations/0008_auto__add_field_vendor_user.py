...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vendor.user'
        db.add_column(u'apparel_vendor', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['profile.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vendor.user'
        db.delete_column(u'apparel_vendor', 'user_id')
