...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_product', 'category_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['apparel.Category'], null=True, blank=True))

        # Changing field 'VendorCategory.category'
        db.alter_column('apparel_vendorcategory', 'category_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['apparel.Category'], null=True, blank=True))

        # Changing field 'Category.parent'
        db.alter_column('apparel_category', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(blank=True, null=True, to=orm['apparel.Category']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Product.category'
        db.alter_column('apparel_product', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Category'], null=True, blank=True))

        # Changing field 'VendorCategory.category'
        db.alter_column('apparel_vendorcategory', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Category'], null=True, blank=True))

        # Changing field 'Category.parent'
        db.alter_column('apparel_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['apparel.Category'], blank=True))
