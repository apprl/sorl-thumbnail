...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Manufacturer.logotype'
        db.alter_column('apparel_manufacturer', 'logotype', self.gf('django.db.models.fields.files.ImageField')(max_length=127))

        # Changing field 'Product.product_image'
        db.alter_column('apparel_product', 'product_image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Changing field 'Vendor.logotype'
        db.alter_column('apparel_vendor', 'logotype', self.gf('django.db.models.fields.files.ImageField')(max_length=127, null=True, blank=True))

        # Changing field 'Look.image'
        db.alter_column('apparel_look', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Manufacturer.logotype'
        db.alter_column('apparel_manufacturer', 'logotype', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Product.product_image'
        db.alter_column('apparel_product', 'product_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Vendor.logotype'
        db.alter_column('apparel_vendor', 'logotype', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'Look.image'
        db.alter_column('apparel_look', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True))
