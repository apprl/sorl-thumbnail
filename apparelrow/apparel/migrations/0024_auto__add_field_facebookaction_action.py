...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookAction.action'
        db.add_column('apparel_facebookaction', 'action',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookAction.action'
        db.delete_column('apparel_facebookaction', 'action')
