...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_category', 'name_order_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.name_order_sv'
        db.alter_column('apparel_category', 'name_order_sv', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.name_order'
        db.alter_column('apparel_category', 'name_order', self.gf('django.db.models.fields.CharField')(max_length=100))
    
    
    def backwards(self, orm):
        
        # Changing field 'Category.name_order_en'
        db.alter_column('apparel_category', 'name_order_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'Category.name_order_sv'
        db.alter_column('apparel_category', 'name_order_sv', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'Category.name_order'
        db.alter_column('apparel_category', 'name_order', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
