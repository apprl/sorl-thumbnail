...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookAction.object_id'
        db.delete_column('apparel_facebookaction', 'object_id')

        # Adding field 'FacebookAction.object_url'
        db.add_column('apparel_facebookaction', 'object_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FacebookAction.object_id'
        db.add_column('apparel_facebookaction', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=''),
                      keep_default=False)

        # Deleting field 'FacebookAction.object_url'
        db.delete_column('apparel_facebookaction', 'object_url')
