...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShortDomainLink.url'
        db.alter_column(u'apparel_shortdomainlink', 'url', self.gf('django.db.models.fields.CharField')(max_length=1024))
        # Adding field 'LookEmbed.hide_border'
        db.add_column(u'apparel_lookembed', 'hide_border',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ShortDomainLink.url'
        db.alter_column(u'apparel_shortdomainlink', 'url', self.gf('django.db.models.fields.CharField')(max_length=512))
        # Deleting field 'LookEmbed.hide_border'
        db.delete_column(u'apparel_lookembed', 'hide_border')
