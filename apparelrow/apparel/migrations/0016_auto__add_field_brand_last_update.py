...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brand.last_update'
        db.add_column('apparel_brand', 'last_update', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Brand.last_update'
        db.delete_column('apparel_brand', 'last_update')
