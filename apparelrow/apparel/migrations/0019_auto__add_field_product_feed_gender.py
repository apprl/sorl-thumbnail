...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.feed_gender'
        db.add_column('apparel_product', 'feed_gender', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=1, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Product.feed_gender'
        db.delete_column('apparel_product', 'feed_gender')
