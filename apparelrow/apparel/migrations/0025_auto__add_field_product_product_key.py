...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.product_key'
        db.add_column(u'apparel_product', 'product_key',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.product_key'
        db.delete_column(u'apparel_product', 'product_key')
