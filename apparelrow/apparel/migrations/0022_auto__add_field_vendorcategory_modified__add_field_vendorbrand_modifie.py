...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VendorCategory.modified'
        db.add_column('apparel_vendorcategory', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VendorBrand.modified'
        db.add_column('apparel_vendorbrand', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VendorCategory.modified'
        db.delete_column('apparel_vendorcategory', 'modified')

        # Deleting field 'VendorBrand.modified'
        db.delete_column('apparel_vendorbrand', 'modified')
