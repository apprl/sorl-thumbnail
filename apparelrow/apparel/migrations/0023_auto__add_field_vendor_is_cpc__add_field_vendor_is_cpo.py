...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vendor.is_cpc'
        db.add_column(u'apparel_vendor', 'is_cpc',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Vendor.is_cpo'
        db.add_column(u'apparel_vendor', 'is_cpo',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vendor.is_cpc'
        db.delete_column(u'apparel_vendor', 'is_cpc')

        # Deleting field 'Vendor.is_cpo'
        db.delete_column(u'apparel_vendor', 'is_cpo')
