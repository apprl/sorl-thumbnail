...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorProduct.buy_url'
        db.alter_column('apparel_vendorproduct', 'buy_url', self.gf('django.db.models.fields.URLField')(max_length=555, null=True, blank=True))
    
    
    def backwards(self, orm):

        # Changing field 'VendorProduct.buy_url'
        db.alter_column('apparel_vendorproduct', 'buy_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True))
