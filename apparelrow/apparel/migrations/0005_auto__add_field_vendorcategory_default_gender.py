...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VendorCategory.default_gender'
        db.add_column('apparel_vendorcategory', 'default_gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VendorCategory.default_gender'
        db.delete_column('apparel_vendorcategory', 'default_gender')
