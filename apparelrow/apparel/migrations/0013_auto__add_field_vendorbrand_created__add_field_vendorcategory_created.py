...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VendorBrand.created'
        db.add_column(u'apparel_vendorbrand', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VendorCategory.created'
        db.add_column(u'apparel_vendorcategory', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VendorBrand.created'
        db.delete_column(u'apparel_vendorbrand', 'created')

        # Deleting field 'VendorCategory.created'
        db.delete_column(u'apparel_vendorcategory', 'created')
