...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Look.image_width'
        db.add_column(u'apparel_look', 'image_width',
                      self.gf('django.db.models.fields.IntegerField')(default=694),
                      keep_default=False)

        # Adding field 'Look.image_height'
        db.add_column(u'apparel_look', 'image_height',
                      self.gf('django.db.models.fields.IntegerField')(default=524),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Look.image_width'
        db.delete_column(u'apparel_look', 'image_width')

        # Deleting field 'Look.image_height'
        db.delete_column(u'apparel_look', 'image_height')
