...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_product', 'manufacturer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['apparel.Brand']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.manufacturer'
        db.alter_column('apparel_product', 'manufacturer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Brand'], null=True))
