...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Look.popularity'
        db.add_column('apparel_look', 'popularity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Look.popularity'
        db.delete_column('apparel_look', 'popularity')
