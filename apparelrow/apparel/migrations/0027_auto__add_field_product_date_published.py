...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.date_published'
        db.add_column('apparel_product', 'date_published',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.date_published'
        db.delete_column('apparel_product', 'date_published')
