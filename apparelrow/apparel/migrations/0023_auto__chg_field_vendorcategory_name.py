...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorCategory.name'
        db.alter_column('apparel_vendorcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=555))
    
    
    def backwards(self, orm):
        
        # Changing field 'VendorCategory.name'
        db.alter_column('apparel_vendorcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
