...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompressedLink'
        db.create_table(u'apparel_compressedlink', (
        ...
        db.send_create_signal(u'apparel', ['CompressedLink'])


    def backwards(self, orm):
        # Deleting model 'CompressedLink'
        db.delete_table(u'apparel_compressedlink')
