...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.singular_name'
        db.add_column('apparel_category', 'singular_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Category.singular_name_en'
        db.add_column('apparel_category', 'singular_name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Category.singular_name_sv'
        db.add_column('apparel_category', 'singular_name_sv',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.singular_name'
        db.delete_column('apparel_category', 'singular_name')

        # Deleting field 'Category.singular_name_en'
        db.delete_column('apparel_category', 'singular_name_en')

        # Deleting field 'Category.singular_name_sv'
        db.delete_column('apparel_category', 'singular_name_sv')
