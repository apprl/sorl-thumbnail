...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apparel_brand', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(null=True, populate_from=('name',), allow_duplicates=False, max_length=100, separator=u'-', blank=True, unique=True, overwrite=False, db_index=True), keep_default=False)
