...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_product', 'product_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Product.product_name'
        db.alter_column('apparel_product', 'product_name', self.gf('django.db.models.fields.CharField')(max_length=200))
