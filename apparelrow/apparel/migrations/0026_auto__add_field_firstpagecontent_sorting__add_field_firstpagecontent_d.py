...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FirstPageContent.sorting'
        db.add_column('apparel_firstpagecontent', 'sorting', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'FirstPageContent.description'
        db.add_column('apparel_firstpagecontent', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FirstPageContent.language'
        db.add_column('apparel_firstpagecontent', 'language', self.gf('django.db.models.fields.CharField')(default='sv', max_length=3), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FirstPageContent.sorting'
        db.delete_column('apparel_firstpagecontent', 'sorting')

        # Deleting field 'FirstPageContent.description'
        db.delete_column('apparel_firstpagecontent', 'description')

        # Deleting field 'FirstPageContent.language'
        db.delete_column('apparel_firstpagecontent', 'language')
