...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apparel_shortproductlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Product'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='short_product_links', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('apparel', ['ShortProductLink'])

        # Adding unique constraint on 'ShortProductLink', fields ['product', 'user']
        db.create_unique('apparel_shortproductlink', ['product_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ShortProductLink', fields ['product', 'user']
        db.delete_unique('apparel_shortproductlink', ['product_id', 'user_id'])

        # Deleting model 'ShortProductLink'
        db.delete_table('apparel_shortproductlink')
