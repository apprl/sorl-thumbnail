...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FirstPageContent.gender'
        db.add_column('apparel_firstpagecontent', 'gender', self.gf('django.db.models.fields.CharField')(default='U', max_length=1), keep_default=False)

        # Adding field 'Look.gender'
        db.add_column('apparel_look', 'gender', self.gf('django.db.models.fields.CharField')(default='U', max_length=1), keep_default=False)
    
    def backwards(self, orm):
        
        # Deleting field 'FirstPageContent.gender'
        db.delete_column('apparel_firstpagecontent', 'gender')

        # Deleting field 'Look.gender'
        db.delete_column('apparel_look', 'gender')
