...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainDeepLinking.quote_url'
        db.add_column(u'apparel_domaindeeplinking', 'quote_url',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DomainDeepLinking.quote_sid'
        db.add_column(u'apparel_domaindeeplinking', 'quote_sid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DomainDeepLinking.quote_ulp'
        db.add_column(u'apparel_domaindeeplinking', 'quote_ulp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainDeepLinking.quote_url'
        db.delete_column(u'apparel_domaindeeplinking', 'quote_url')

        # Deleting field 'DomainDeepLinking.quote_sid'
        db.delete_column(u'apparel_domaindeeplinking', 'quote_sid')

        # Deleting field 'DomainDeepLinking.quote_ulp'
        db.delete_column(u'apparel_domaindeeplinking', 'quote_ulp')
    ...
    models = {
        ...
        u'apparel.compressedlink': {
            'Meta': {'object_name': 'CompressedLink'},
        ...
        u'apparel.domaindeeplinking': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quote_sid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'quote_ulp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'quote_url': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'apparel.look': {
            ...
            'popularity2': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8', 'db_index': 'True'}),
        ...
        u'apparel.lookembed': {
            ...
            'hide_border': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'apparel.productwidget': {
            ...
            'widget_type': ('django.db.models.fields.CharField', [], {'default': "'single'", 'max_length': '10'})
        },
