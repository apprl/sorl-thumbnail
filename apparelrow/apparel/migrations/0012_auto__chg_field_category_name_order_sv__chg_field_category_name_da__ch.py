...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.name_order_sv'
        db.alter_column(u'apparel_category', 'name_order_sv', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_da'
        db.alter_column(u'apparel_category', 'name_da', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_order_no'
        db.alter_column(u'apparel_category', 'name_order_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_en'
        db.alter_column(u'apparel_category', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_order_en'
        db.alter_column(u'apparel_category', 'name_order_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_sv'
        db.alter_column(u'apparel_category', 'name_sv', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_no'
        db.alter_column(u'apparel_category', 'name_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.name_order_da'
        db.alter_column(u'apparel_category', 'name_order_da', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Category.name_order_sv'
        db.alter_column(u'apparel_category', 'name_order_sv', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_da'
        db.alter_column(u'apparel_category', 'name_da', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_order_no'
        db.alter_column(u'apparel_category', 'name_order_no', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_en'
        db.alter_column(u'apparel_category', 'name_en', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_order_en'
        db.alter_column(u'apparel_category', 'name_order_en', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_sv'
        db.alter_column(u'apparel_category', 'name_sv', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_no'
        db.alter_column(u'apparel_category', 'name_no', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Category.name_order_da'
        db.alter_column(u'apparel_category', 'name_order_da', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
