...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Copy price and currency data to original fields. This will allow the
        price to be converted to the base currency
        """
        
        orm.VendorProduct.objects.filter(
            original_currency=None,
            original_price=None
        ).update(
            original_currency=models.F('currency'),
            original_price=models.F('price'),
        )
    
    def backwards(self, orm):
        "Write your backwards methods here."
        
        orm.VendorProduct.objects.update(
            original_currency=None,
            original_price=None
        )
