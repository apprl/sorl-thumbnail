...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InternalReferral'
        db.create_table(u'apparel_internalreferral', (
            ...
            ('page', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('user_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('expired', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('expires', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'apparel', ['InternalReferral'])


    def backwards(self, orm):
        # Deleting model 'InternalReferral'
        db.delete_table(u'apparel_internalreferral')
