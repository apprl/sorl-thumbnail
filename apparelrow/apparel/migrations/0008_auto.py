...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Product', fields ['popularity']
        db.create_index('apparel_product', ['popularity'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Product', fields ['popularity']
        db.delete_index('apparel_product', ['popularity'])
