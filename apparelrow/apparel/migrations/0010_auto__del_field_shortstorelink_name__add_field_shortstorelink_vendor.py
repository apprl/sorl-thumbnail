...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShortStoreLink.name'
        db.delete_column(u'apparel_shortstorelink', 'name')

        # Adding field 'ShortStoreLink.vendor'
        db.add_column(u'apparel_shortstorelink', 'vendor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['apparel.Vendor']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ShortStoreLink.name'
        db.add_column(u'apparel_shortstorelink', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=16),
                      keep_default=False)

        # Deleting field 'ShortStoreLink.vendor'
        db.delete_column(u'apparel_shortstorelink', 'vendor_id')
