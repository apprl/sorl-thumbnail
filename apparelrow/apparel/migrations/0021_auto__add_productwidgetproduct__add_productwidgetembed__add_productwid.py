...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductWidgetProduct'
        db.create_table(u'apparel_productwidgetproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product_widget_embed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.ProductWidget'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Product'])),
        ))
        db.send_create_signal(u'apparel', ['ProductWidgetProduct'])

        # Adding model 'ProductWidgetEmbed'
        db.create_table(u'apparel_productwidgetembed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product_widget', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_widget', to=orm['apparel.ProductWidget'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_widget_embed', to=orm['profile.User'])),
        ...
        # Adding model 'ProductWidget'
        db.create_table(u'apparel_productwidget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_widget', to=orm['profile.User'])),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'apparel', ['ProductWidget'])


    def backwards(self, orm):
        # Deleting model 'ProductWidgetProduct'
        db.delete_table(u'apparel_productwidgetproduct')

        # Deleting model 'ProductWidgetEmbed'
        db.delete_table(u'apparel_productwidgetembed')

        # Deleting model 'ProductWidget'
        db.delete_table(u'apparel_productwidget')
