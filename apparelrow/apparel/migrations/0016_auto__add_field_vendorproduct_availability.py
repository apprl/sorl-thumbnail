...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VendorProduct.availability'
        db.add_column('apparel_vendorproduct', 'availability', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VendorProduct.availability'
        db.delete_column('apparel_vendorproduct', 'availability')
