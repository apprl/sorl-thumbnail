...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Look.width'
        db.add_column('apparel_look', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=694),
                      keep_default=False)

        # Adding field 'Look.height'
        db.add_column('apparel_look', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=524),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Look.width'
        db.delete_column('apparel_look', 'width')

        # Deleting field 'Look.height'
        db.delete_column('apparel_look', 'height')
