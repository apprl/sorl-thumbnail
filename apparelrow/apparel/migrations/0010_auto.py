...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Manufacturer', fields ['name']
        db.create_index('apparel_manufacturer', ['name'])

        # Adding index on 'OptionType', fields ['name']
        db.create_index('apparel_optiontype', ['name'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Manufacturer', fields ['name']
        db.delete_index('apparel_manufacturer', ['name'])

        # Removing index on 'OptionType', fields ['name']
        db.delete_index('apparel_optiontype', ['name'])
