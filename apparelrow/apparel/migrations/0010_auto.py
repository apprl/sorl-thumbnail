...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Vendor', fields ['name']
        db.create_index('apparel_vendor', ['name'])

        # Adding index on 'Category', fields ['name_sv']
        db.create_index('apparel_category', ['name_sv'])

        # Adding index on 'Category', fields ['name']
        db.create_index('apparel_category', ['name'])

        # Adding index on 'Category', fields ['name_en']
        db.create_index('apparel_category', ['name_en'])

        # Adding index on 'Category', fields ['active']
        db.create_index('apparel_category', ['active'])

        # Adding index on 'Category', fields ['on_front_page']
        db.create_index('apparel_category', ['on_front_page'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Vendor', fields ['name']
        db.delete_index('apparel_vendor', ['name'])

        # Removing index on 'Category', fields ['name_sv']
        db.delete_index('apparel_category', ['name_sv'])

        # Removing index on 'Category', fields ['name']
        db.delete_index('apparel_category', ['name'])

        # Removing index on 'Category', fields ['name_en']
        db.delete_index('apparel_category', ['name_en'])

        # Removing index on 'Category', fields ['active']
        db.delete_index('apparel_category', ['active'])

        # Removing index on 'Category', fields ['on_front_page']
        db.delete_index('apparel_category', ['on_front_page'])
