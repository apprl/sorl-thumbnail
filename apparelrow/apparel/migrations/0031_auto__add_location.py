...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'apparel_location', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=3, primary_key=True)),
        ))
        db.send_create_signal(u'apparel', ['Location'])

        # Adding M2M table for field locations on 'Vendor'
        m2m_table_name = db.shorten_name(u'apparel_vendor_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vendor', models.ForeignKey(orm[u'apparel.vendor'], null=False)),
            ('location', models.ForeignKey(orm[u'apparel.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['vendor_id', 'location_id'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'apparel_location')

        # Removing M2M table for field locations on 'Vendor'
        db.delete_table(db.shorten_name(u'apparel_vendor_locations'))
