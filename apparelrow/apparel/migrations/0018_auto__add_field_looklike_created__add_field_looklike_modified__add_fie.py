...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LookLike.created'
        db.add_column('apparel_looklike', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'LookLike.modified'
        db.add_column('apparel_looklike', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'LookLike.active'
        db.add_column('apparel_looklike', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'ProductLike.created'
        db.add_column('apparel_productlike', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'ProductLike.modified'
        db.add_column('apparel_productlike', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'ProductLike.active'
        db.add_column('apparel_productlike', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'LookLike.created'
        db.delete_column('apparel_looklike', 'created')

        # Deleting field 'LookLike.modified'
        db.delete_column('apparel_looklike', 'modified')

        # Deleting field 'LookLike.active'
        db.delete_column('apparel_looklike', 'active')

        # Deleting field 'ProductLike.created'
        db.delete_column('apparel_productlike', 'created')

        # Deleting field 'ProductLike.modified'
        db.delete_column('apparel_productlike', 'modified')

        # Deleting field 'ProductLike.active'
        db.delete_column('apparel_productlike', 'active')
