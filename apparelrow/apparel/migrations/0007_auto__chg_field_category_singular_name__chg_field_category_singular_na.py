...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.singular_name'
        db.alter_column(u'apparel_category', 'singular_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.singular_name_da'
        db.alter_column(u'apparel_category', 'singular_name_da', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.singular_name_no'
        db.alter_column(u'apparel_category', 'singular_name_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.singular_name_en'
        db.alter_column(u'apparel_category', 'singular_name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Category.singular_name_sv'
        db.alter_column(u'apparel_category', 'singular_name_sv', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Category.singular_name'
        db.alter_column(u'apparel_category', 'singular_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.singular_name_da'
        db.alter_column(u'apparel_category', 'singular_name_da', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.singular_name_no'
        db.alter_column(u'apparel_category', 'singular_name_no', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.singular_name_en'
        db.alter_column(u'apparel_category', 'singular_name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Category.singular_name_sv'
        db.alter_column(u'apparel_category', 'singular_name_sv', self.gf('django.db.models.fields.CharField')(max_length=100))
