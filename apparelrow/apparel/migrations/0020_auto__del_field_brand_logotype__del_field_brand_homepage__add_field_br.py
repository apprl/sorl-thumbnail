...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Brand.logotype'
        db.delete_column('apparel_brand', 'logotype')

        # Deleting field 'Brand.homepage'
        db.delete_column('apparel_brand', 'homepage')

        # Adding field 'Brand.old_name'
        db.add_column('apparel_brand', 'old_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Brand.logotype'
        db.add_column('apparel_brand', 'logotype',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Brand.homepage'
        db.add_column('apparel_brand', 'homepage',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Brand.old_name'
        db.delete_column('apparel_brand', 'old_name')
    ...
    models = {
        ...
        'apparel.firstpagecontent': {
            'Meta': {'ordering': "['sorting', '-pub_date']", 'object_name': 'FirstPageContent'},
