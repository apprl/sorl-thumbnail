...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding column 'created' to WardrobeProduct
        db.add_column('apparel_wardrobe_products', 'created', models.DateTimeField(_("Time created"), auto_now_add=True, blank=False, default=datetime.datetime.now()), keep_default=False)
    
    def backwards(self, orm):

        # Deleting column 'created' from WardrobeProduct
        db.delete_column('apparel_wardrobe_products', 'created')
    ...
    models = {
        ...
        'apparel.wardrobe': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['apparel.Product']", 'through': "orm['apparel.WardrobeProducts']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'apparel.wardrobeproducts': {
            'Meta': {'object_name': 'WardrobeProducts', 'db_table': "'apparel_wardrobe_products'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'products': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apparel.Product']"}),
