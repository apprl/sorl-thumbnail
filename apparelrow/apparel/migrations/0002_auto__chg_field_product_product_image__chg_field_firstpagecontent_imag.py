...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_product', 'product_image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255))

        # Changing field 'FirstPageContent.image'
        db.alter_column('apparel_firstpagecontent', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True))

        # Changing field 'Look.image'
        db.alter_column('apparel_look', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FirstPageContent.image'
        db.alter_column('apparel_firstpagecontent', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True))
