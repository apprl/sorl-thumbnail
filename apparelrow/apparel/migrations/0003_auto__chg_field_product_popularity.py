...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apparel_product', 'popularity', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))
    
    
    def backwards(self, orm):
        
        # Changing field 'Product.popularity'
        db.alter_column('apparel_product', 'popularity', self.gf('django.db.models.fields.IntegerField')())
