...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'apparel_category', 'name_fi',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_order_fi'
        db.add_column(u'apparel_category', 'name_order_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.singular_name_fi'
        db.add_column(u'apparel_category', 'singular_name_fi',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'apparel_category', 'name_fi')

        # Deleting field 'Category.name_order_fi'
        db.delete_column(u'apparel_category', 'name_order_fi')

        # Deleting field 'Category.singular_name_fi'
        db.delete_column(u'apparel_category', 'singular_name_fi')
