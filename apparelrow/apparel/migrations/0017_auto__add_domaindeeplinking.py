...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DomainDeepLinking'
        db.create_table(u'apparel_domaindeeplinking', (
        ...
        db.send_create_signal(u'apparel', ['DomainDeepLinking'])


    def backwards(self, orm):
        # Deleting model 'DomainDeepLinking'
        db.delete_table(u'apparel_domaindeeplinking')
