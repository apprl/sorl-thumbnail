...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShortStoreLink'
        db.create_table(u'apparel_shortstorelink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'apparel', ['ShortStoreLink'])


    def backwards(self, orm):
        # Deleting model 'ShortStoreLink'
        db.delete_table(u'apparel_shortstorelink')
