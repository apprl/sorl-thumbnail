...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductUsedWeekly'
        db.create_table(u'apparel_productusedweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Product'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'apparel', ['ProductUsedWeekly'])


    def backwards(self, orm):
        # Deleting model 'ProductUsedWeekly'
        db.delete_table(u'apparel_productusedweekly')
