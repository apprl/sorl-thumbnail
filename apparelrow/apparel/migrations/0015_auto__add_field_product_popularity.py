...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.popularity'
        db.add_column('apparel_product', 'popularity', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Product.popularity'
        db.delete_column('apparel_product', 'popularity')
