...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apparel_category', 'name_sv', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Category.name_en'
        db.add_column('apparel_category', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Category.name_sv'
        db.delete_column('apparel_category', 'name_sv')

        # Deleting field 'Category.name_en'
        db.delete_column('apparel_category', 'name_en')
