...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Product', fields ['gender']
        db.create_index('apparel_product', ['gender'])

        # Adding index on 'Product', fields ['published']
        db.create_index('apparel_product', ['published'])

        # Adding index on 'Product', fields ['date_added']
        db.create_index('apparel_product', ['date_added'])

        # Changing field 'FirstPageContent.pub_date'
        db.alter_column('apparel_firstpagecontent', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
    
    
    def backwards(self, orm):
        
        # Removing index on 'Product', fields ['gender']
        db.delete_index('apparel_product', ['gender'])

        # Removing index on 'Product', fields ['published']
        db.delete_index('apparel_product', ['published'])

        # Removing index on 'Product', fields ['date_added']
        db.delete_index('apparel_product', ['date_added'])

        # Changing field 'FirstPageContent.pub_date'
        db.alter_column('apparel_firstpagecontent', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
    ...
    models = {
        'apparel.category': {
            ...
            'name_sv': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
