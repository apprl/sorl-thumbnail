...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LookEmbed'
        db.create_table(u'apparel_lookembed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('look', self.gf('django.db.models.fields.related.ForeignKey')(related_name='embeds', to=orm['apparel.Look'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='look_embeds', to=orm['profile.User'])),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('width', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'apparel', ['LookEmbed'])


    def backwards(self, orm):
        # Deleting model 'LookEmbed'
        db.delete_table(u'apparel_lookembed')
