...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apparel_facebookaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facebook_actions', to=orm['auth.User'])),
        ...
        db.send_create_signal('apparel', ['FacebookAction'])


    def backwards(self, orm):
        # Deleting model 'FacebookAction'
        db.delete_table('apparel_facebookaction')
