...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserEarning.amount'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserEarning.amount'
        db.alter_column(u'dashboard_userearning', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))
        # Deleting field 'Cut.rules_exceptions'
        db.delete_column(u'dashboard_cut', 'rules_exceptions')
