...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dashboard_group', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.owner_cut'
        db.add_column(u'dashboard_group', 'owner_cut',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=10, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.owner'
        db.delete_column(u'dashboard_group', 'owner_id')

        # Deleting field 'Group.owner_cut'
        db.delete_column(u'dashboard_group', 'owner_cut')
    ...
    models = {
        ...
        u'dashboard.group': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profile.User']", 'null': 'True', 'blank': 'True'}),
            'owner_cut': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '3', 'blank': 'True'})
        },
        u'dashboard.payment': {
