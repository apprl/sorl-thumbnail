...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_payment', (
        ...
        db.send_create_signal('dashboard', ['Payment'])

        # Adding field 'Sale.paid'
        db.add_column('dashboard_sale', 'paid',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('dashboard_payment')

        # Deleting field 'Sale.paid'
        db.delete_column('dashboard_sale', 'paid')
