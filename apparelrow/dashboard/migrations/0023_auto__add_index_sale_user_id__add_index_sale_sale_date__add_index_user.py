...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sale', fields ['user_id']
        db.create_index(u'dashboard_sale', ['user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Sale', fields ['user_id']
        db.delete_index(u'dashboard_sale', ['user_id'])
    ...
    models = {
        ...
        u'dashboard.sale': {
            ...
            'sale_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'user_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
