...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.is_referral_sale'
        db.add_column(u'dashboard_sale', 'is_referral_sale',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sale.referral_user'
        db.add_column(u'dashboard_sale', 'referral_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.is_referral_sale'
        db.delete_column(u'dashboard_sale', 'is_referral_sale')

        # Deleting field 'Sale.referral_user'
        db.delete_column(u'dashboard_sale', 'referral_user_id')
