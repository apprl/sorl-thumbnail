...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sale', fields ['status']
        db.create_index('dashboard_sale', ['status'])


    def backwards(self, orm):
        # Removing index on 'Sale', fields ['status']
        db.delete_index('dashboard_sale', ['status'])
    ...
    models = {
        ...
        'dashboard.sale': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'I'", 'max_length': '1', 'db_index': 'True'}),
