...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.referral_user'
        db.add_column(u'dashboard_signup', 'referral_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signup.referral_user'
        db.delete_column(u'dashboard_signup', 'referral_user_id')
