...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table('dashboard_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('dashboard', ['Group'])

        # Adding model 'Cut'
        db.create_table('dashboard_cut', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dashboard', ['Cut'])


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table('dashboard_group')

        # Deleting model 'Cut'
        db.delete_table('dashboard_cut')
