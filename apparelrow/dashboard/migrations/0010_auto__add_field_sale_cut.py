...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.cut'
        db.add_column(u'dashboard_sale', 'cut',
                      self.gf('django.db.models.fields.DecimalField')(default='0.67', max_digits=10, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.cut'
        db.delete_column(u'dashboard_sale', 'cut')
