...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.has_cpc_all_stores'
        db.add_column(u'dashboard_group', 'has_cpc_all_stores',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cut.cpc_amount'
        db.add_column(u'dashboard_cut', 'cpc_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Cut.cpc_currency'
        db.add_column(u'dashboard_cut', 'cpc_currency',
                      self.gf('django.db.models.fields.CharField')(default='EUR', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.has_cpc_all_stores'
        db.delete_column(u'dashboard_group', 'has_cpc_all_stores')

        # Deleting field 'Cut.cpc_amount'
        db.delete_column(u'dashboard_cut', 'cpc_amount')

        # Deleting field 'Cut.cpc_currency'
        db.delete_column(u'dashboard_cut', 'cpc_currency')
    ...
    models = {
        ...
        u'dashboard.cut': {
            ...
            'cpc_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '2'}),
            'cpc_currency': ('django.db.models.fields.CharField', [], {'default': "'EUR'", 'max_length': '3'}),
        ...
        u'dashboard.payment': {
            ...
            'earnings': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'profile.paymentdetail': {
            ...
            'bank_name': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'banknr': ('django.db.models.fields.CharField', [], {'max_length': '34', 'null': 'True', 'blank': 'True'}),
            'care_of': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
