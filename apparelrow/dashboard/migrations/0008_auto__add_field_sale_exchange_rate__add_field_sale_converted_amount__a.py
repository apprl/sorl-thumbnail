...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.exchange_rate'
        db.add_column('dashboard_sale', 'exchange_rate',
                      self.gf('django.db.models.fields.DecimalField')(default='1', max_digits=10, decimal_places=6),
                      keep_default=False)

        # Adding field 'Sale.converted_amount'
        db.add_column('dashboard_sale', 'converted_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sale.converted_commission'
        db.add_column('dashboard_sale', 'converted_commission',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.exchange_rate'
        db.delete_column('dashboard_sale', 'exchange_rate')

        # Deleting field 'Sale.converted_amount'
        db.delete_column('dashboard_sale', 'converted_amount')

        # Deleting field 'Sale.converted_commission'
        db.delete_column('dashboard_sale', 'converted_commission')
