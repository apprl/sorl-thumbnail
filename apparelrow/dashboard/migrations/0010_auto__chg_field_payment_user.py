...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dashboard_payment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.User']))

    def backwards(self, orm):

        # Changing field 'Payment.user'
        db.alter_column(u'dashboard_payment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
