...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserEarning.payment'
        db.add_column(u'dashboard_userearning', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Payment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserEarning.payment'
        db.delete_column(u'dashboard_userearning', 'payment_id')
    ...
    models = {
        ...
        u'dashboard.userearning': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paid': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.Payment']", 'null': 'True'}),
