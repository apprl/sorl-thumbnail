...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreCommission'
        db.create_table(u'dashboard_storecommission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Vendor'])),
            ('commission', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'dashboard', ['StoreCommission'])


    def backwards(self, orm):
        # Deleting model 'StoreCommission'
        db.delete_table(u'dashboard_storecommission')
