...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cut.referral_cut'
        db.add_column(u'dashboard_cut', 'referral_cut',
                      self.gf('django.db.models.fields.DecimalField')(default='0.33', max_digits=10, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cut.referral_cut'
        db.delete_column(u'dashboard_cut', 'referral_cut')
