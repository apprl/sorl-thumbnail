...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.adjusted_date'
        db.add_column('dashboard_sale', 'adjusted_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.adjusted_date'
        db.delete_column('dashboard_sale', 'adjusted_date')
