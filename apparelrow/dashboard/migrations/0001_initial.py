...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sale'
        db.create_table('dashboard_sale', (
            ...
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True)),
        ...
        db.send_create_signal('dashboard', ['Sale'])


    def backwards(self, orm):
        # Deleting model 'Sale'
        db.delete_table('dashboard_sale')
