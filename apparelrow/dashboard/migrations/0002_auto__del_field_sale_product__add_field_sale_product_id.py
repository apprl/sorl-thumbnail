...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sale.product'
        db.delete_column(u'dashboard_sale', 'product_id')

        # Adding field 'Sale.product_id'
        db.add_column(u'dashboard_sale', 'product_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sale.product'
        db.add_column(u'dashboard_sale', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Product'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Deleting field 'Sale.product_id'
        db.delete_column(u'dashboard_sale', 'product_id')
