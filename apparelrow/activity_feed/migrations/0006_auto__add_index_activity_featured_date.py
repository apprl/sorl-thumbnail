...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Activity', fields ['featured_date']
        db.create_index(u'activity_feed_activity', ['featured_date'])


    def backwards(self, orm):
        # Removing index on 'Activity', fields ['featured_date']
        db.delete_index(u'activity_feed_activity', ['featured_date'])
    ...
    models = {
        u'activity_feed.activity': {
            ...
            'featured_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'object_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
