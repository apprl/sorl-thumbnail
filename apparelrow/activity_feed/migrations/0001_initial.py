...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activity_feed_activity', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activities', to=orm['profile.User'])),
        ...
        db.create_unique(u'activity_feed_activity', ['user_id', 'verb', 'content_type_id', 'object_id'])

        # Adding model 'ActivityFeed'
        db.create_table(u'activity_feed_activityfeed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_feeds', to=orm['profile.User'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['profile.User'])),
            ('verb', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal(u'activity_feed', ['ActivityFeed'])

        # Adding unique constraint on 'ActivityFeed', fields ['owner', 'user', 'verb', 'content_type', 'object_id']
        db.create_unique(u'activity_feed_activityfeed', ['owner_id', 'user_id', 'verb', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActivityFeed', fields ['owner', 'user', 'verb', 'content_type', 'object_id']
        db.delete_unique(u'activity_feed_activityfeed', ['owner_id', 'user_id', 'verb', 'content_type_id', 'object_id'])

        # Removing unique constraint on 'Activity', fields ['user', 'verb', 'content_type', 'object_id']
        db.delete_unique(u'activity_feed_activity', ['user_id', 'verb', 'content_type_id', 'object_id'])

        # Deleting model 'Activity'
        db.delete_table(u'activity_feed_activity')

        # Deleting model 'ActivityFeed'
        db.delete_table(u'activity_feed_activityfeed')
