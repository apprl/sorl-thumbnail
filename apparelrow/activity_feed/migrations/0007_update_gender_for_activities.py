...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for activity in orm['activity_feed.Activity'].objects.all():
            if activity.content_type.name == 'look':
                try:
                    look = orm['apparel.Look'].objects.get(pk=activity.object_id)
                    activity.gender = look.gender
                    activity.save()
    ...
    complete_apps = ['apparel', 'activity_feed']
    symmetrical = True
