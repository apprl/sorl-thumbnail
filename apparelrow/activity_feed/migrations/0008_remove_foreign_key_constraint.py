...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_foreign_key('activity_feed_activity', 'user_id')
        db.delete_unique('activity_feed_activity', ['user_id', 'verb', 'content_type_id', 'object_id'])
        db.delete_foreign_key('activity_feed_activityfeed', 'owner_id')
        db.delete_foreign_key('activity_feed_activityfeed', 'user_id')
        db.delete_unique('activity_feed_activityfeed', ['owner_id', 'user_id', 'verb', 'content_type_id', 'object_id'])

    def backwards(self, orm):
        sql = db.foreign_key_sql('activity_feed_activity', 'user_id', 'profile_apparelprofile', 'id')
        db.execute(sql)
        db.create_unique('activity_feed_activity', ['user_id', 'verb', 'content_type_id', 'object_id'])
        sql = db.foreign_key_sql('activity_feed_activityfeed', 'owner_id', 'profile_apparelprofile', 'id')
        db.execute(sql)
        sql = db.foreign_key_sql('activity_feed_activityfeed', 'user_id', 'profile_apparelprofile', 'id')
        db.execute(sql)
