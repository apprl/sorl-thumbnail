...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.object_count'
        db.add_column(u'activity_feed_activity', 'object_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.object_count'
        db.delete_column(u'activity_feed_activity', 'object_count')
