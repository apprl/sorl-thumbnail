...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        sql = db.foreign_key_sql('activity_feed_activity', 'user_id', 'profile_user', 'id')
        db.execute(sql)
        db.create_unique('activity_feed_activity', ['user_id', 'verb', 'content_type_id', 'object_id'])
        sql = db.foreign_key_sql('activity_feed_activityfeed', 'owner_id', 'profile_user', 'id')
        db.execute(sql)
        sql = db.foreign_key_sql('activity_feed_activityfeed', 'user_id', 'profile_user', 'id')
        db.execute(sql)
