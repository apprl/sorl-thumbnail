...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'Activity', fields ['active']
        db.delete_index(u'activity_feed_activity', ['active'])

        # Adding index on 'Activity', fields ['content_type', 'object_id']
        db.create_index(u'activity_feed_activity', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing index on 'Activity', fields ['content_type', 'object_id']
        db.delete_index(u'activity_feed_activity', ['content_type_id', 'object_id'])

        # Adding index on 'Activity', fields ['active']
        db.create_index(u'activity_feed_activity', ['active'])
    ...
    models = {
        u'activity_feed.activity': {
            'Meta': {'unique_together': "(('user', 'verb', 'content_type', 'object_id'),)", 'object_name': 'Activity', 'index_together': "[['active', 'verb', 'is_available', 'user', 'gender'], ['active', 'featured_date'], ['content_type', 'object_id']]"},
