...
class BooztSESpider(CSVFeedSpider, AffiliateMixin):
    name = 'boozt-se'
    allowed_domains = ['boozt.com']
    start_urls = ['http://pf.tradedoubler.com/export/export?myFeed=14183115841853028&myFormat=12919846971897050']
    delimiter = '|'

    def parse_rows(self, response):
        response = response.replace(encoding='iso-8859-1')
        return super(BooztSESpider, self).parse_rows(response)
