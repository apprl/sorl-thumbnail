...
class Rum21SESpider(XMLFeedSpider, AffiliateMixin, PriceMixin, KeyExtractorMixin):
    name = 'rum21-se'
    allowed_domains = ['rum21.se']
    start_urls = ['http://www.rum21.se/agent/Google_SE_products_gs7sa.xml']
