...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UrlDetail.parameters'
        db.delete_column(u'product_match_urldetail', 'parameters')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UrlDetail.parameters'
        db.add_column(u'product_match_urldetail', 'parameters',
