...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UrlDetail'
        db.create_table(u'product_match_urldetail', (
            ...
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ...
            ('fragment', self.gf('django.db.models.fields.CharField')(max_length=505, null=True, blank=True)),
        ...
        db.send_create_signal(u'product_match', ['UrlDetail'])

        # Adding model 'UrlVendorSpecificParams'
        db.create_table(u'product_match_urlvendorspecificparams', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('parameter_name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'product_match', ['UrlVendorSpecificParams'])


    def backwards(self, orm):
        # Deleting model 'UrlDetail'
        db.delete_table(u'product_match_urldetail')

        # Deleting model 'UrlVendorSpecificParams'
        db.delete_table(u'product_match_urlvendorspecificparams')
    ...
    models = {
        ...
        u'product_match.urldetail': {
            'Meta': {'object_name': 'UrlDetail'},
            'created': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'fragment': ('django.db.models.fields.CharField', [], {'max_length': '505', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'product_match.urlvendorspecificparams': {
            'Meta': {'object_name': 'UrlVendorSpecificParams'},
            'created': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'parameter_name': ('django.db.models.fields.CharField', [], {'max_length': '512'})
        },
        u'profile.user': {
