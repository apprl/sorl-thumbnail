...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'theimp_category')

        # Deleting model 'Brand'
        db.delete_table(u'theimp_brand')


        # Changing field 'BrandMapping.mapped_brand'
        db.alter_column(u'theimp_brandmapping', 'mapped_brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Brand'], null=True))

        # Changing field 'CategoryMapping.mapped_category'
        db.alter_column(u'theimp_categorymapping', 'mapped_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apparel.Category'], null=True))

    def backwards(self, orm):
        # Adding model 'Category'
        db.create_table(u'theimp_category', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'theimp', ['Category'])

        # Adding model 'Brand'
        db.create_table(u'theimp_brand', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'theimp', ['Brand'])


        # Changing field 'BrandMapping.mapped_brand'
        db.alter_column(u'theimp_brandmapping', 'mapped_brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theimp.Brand'], null=True))

        # Changing field 'CategoryMapping.mapped_category'
        db.alter_column(u'theimp_categorymapping', 'mapped_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theimp.Category'], null=True))
