...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for vendorbrand in orm['apparel.VendorBrand'].objects.iterator():
            ...
            try:
                mapping = orm['theimp.BrandMapping'].objects.get(vendor=vendor, brand=vendorbrand.name)
                mapping.mapped_brand = vendorbrand.brand
                mapping.save()
            except Exception:
                pass
        ...
        for vendorcategory in orm['apparel.VendorCategory'].objects.iterator():
            ...
            try:
                mapping = orm['theimp.CategoryMapping'].objects.get(vendor=vendor, category=vendorcategory.name)
                mapping.mapped_category = vendorcategory.category
                mapping.save()
            except Exception:
                pass
    ...
    complete_apps = ['theimp', 'apparel', 'theimp']
    symmetrical = True
