...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryMapping.products_counter'
        db.add_column(u'theimp_categorymapping', 'products_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryMapping.products_counter'
        db.delete_column(u'theimp_categorymapping', 'products_counter')
