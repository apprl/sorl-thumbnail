...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_released'
        db.add_column(u'theimp_product', 'is_released',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_released'
        db.delete_column(u'theimp_product', 'is_released')
