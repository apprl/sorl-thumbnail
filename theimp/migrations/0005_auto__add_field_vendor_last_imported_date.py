...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vendor.last_imported_date'
        db.add_column(u'theimp_vendor', 'last_imported_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vendor.last_imported_date'
        db.delete_column(u'theimp_vendor', 'last_imported_date')
