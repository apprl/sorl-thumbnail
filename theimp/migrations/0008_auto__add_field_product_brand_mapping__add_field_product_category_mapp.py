...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.brand_mapping'
        db.add_column(u'theimp_product', 'brand_mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', null=True, to=orm['theimp.BrandMapping']),
                      keep_default=False)

        # Adding field 'Product.category_mapping'
        db.add_column(u'theimp_product', 'category_mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', null=True, to=orm['theimp.CategoryMapping']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.brand_mapping'
        db.delete_column(u'theimp_product', 'brand_mapping_id')

        # Deleting field 'Product.category_mapping'
        db.delete_column(u'theimp_product', 'category_mapping_id')
